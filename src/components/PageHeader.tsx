  ...
  return (
    <div className='mb-4 flex flex-wrap items-center justify-between gap-2 sm:gap-4'>
      <div className='flex items-center gap-2'>
        <img src='/logo.png' alt='Logo' className='h-9 w-9 rounded-xl border border-white/20 sm:h-11 sm:w-11' />
        <h1 className='text-2xl font-black tracking-tight text-white sm:text-3xl'>ZTN</h1>
      </div>
